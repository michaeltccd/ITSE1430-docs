...
There are several editions available but you must ensure you use the version listed in the course requirements. Community Edition is free and can be downloaed https://visualstudio.microsoft.com/vs/community/[here]. 
