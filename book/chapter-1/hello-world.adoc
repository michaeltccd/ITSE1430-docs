...
NOTE: The above code is moree complex than we need for demonstration purposes. Going forward keep the `Do not use top-level statements` checkbox unchecked to simplify the code.
